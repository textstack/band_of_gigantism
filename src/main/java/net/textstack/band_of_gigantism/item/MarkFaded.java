...
public class MarkFaded extends Item implements ICurioItem {
    ...
    public void addInformation(@NotNull ItemStack stack, @Nullable World worldIn, @NotNull List<ITextComponent> tooltip, @NotNull ITooltipFlag flagIn) {
        ...
        if (worldIn==null||!BOGItems.descriptionEnable()) return;
        ...
        if (Screen.hasShiftDown()) {
            ...
            tooltip.add(new TranslationTextComponent("tooltip.band_of_gigantism.void"));
            tooltip.add(LoreStatHelper.displayStat((float) BOGMarks.markFadedFlatResistance(), LoreStatHelper.Stat.FLAT_RESISTANCE));
            //tooltip.add(new TranslationTextComponent("tooltip.band_of_gigantism.mark_faded_description_0"));
            tooltip.add(LoreStatHelper.displayStat((float) BOGMarks.markFadedDamage(), LoreStatHelper.Stat.DAMAGE, true));
            //tooltip.add(new TranslationTextComponent("tooltip.band_of_gigantism.mark_faded_description_1"));
            tooltip.add(new TranslationTextComponent("tooltip.band_of_gigantism.void"));
            tooltip.add(LoreStatHelper.displayStat((float) BOGMarks.markFadedHealing(), LoreStatHelper.Stat.HEALING, true));
